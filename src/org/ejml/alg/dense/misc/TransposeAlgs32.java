...
public class TransposeAlgs32 {
     ...
     */
    public static void square( D1Matrix32F mat )
    {
        int index = 1;
     ...
     */
    public static void block( D1Matrix32F A , D1Matrix32F A_tran ,
...
//                    for( int k = 0; k < blockHeight; k++ , rowSrc += A.numCols ) {
     ...
     * @param A_tran Transposed matrix.  Modified.
     */
    public static void standard( D1Matrix32F A, D1Matrix32F A_tran)
    {
        int index = 0;
