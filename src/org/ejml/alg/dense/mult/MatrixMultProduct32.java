 ...
 * @author Peter Abeles
 */
public class MatrixMultProduct32 {

    public static void outer(D1Matrix32F a, D1Matrix32F c) {
...
//        }
    ...
    public static void inner_small(D1Matrix32F a, D1Matrix32F c) {
...
//        }
    ...
    public static void inner_reorder(D1Matrix32F a, D1Matrix32F c) {
...
//        }
    ...
    public static void inner_reorder_upper(D1Matrix32F a, D1Matrix32F c) {
        for( int i = 0; i < a.numCols; i++ ) {
            int indexC = i*c.numCols+i;
            float valAi = a.data[i];
            for( int j = i; j < a.numCols; j++ ) {
