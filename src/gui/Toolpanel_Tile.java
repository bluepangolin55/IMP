...
public class Toolpanel_Tile 
extends Tile{
	
	private List<Toolbutton> toolbuttons;
	
	public Toolpanel_Tile(int alignment, Dimension size) {
		...
		for(int i=0; i<IMP.tools.size();i++){
			Toolbutton toolbutton=new Toolbutton(IMP.tools.get(i));
