...
public class MatrixInt {
	...
	public MatrixInt(double[][] values) {
		this.values=values;
	}
...
//	}
	...
	public MatrixInt transpose (){
		MatrixInt transpose = new MatrixInt(columns(), rows());
	...
	public static MatrixInt sum (MatrixInt A, MatrixInt B){
		MatrixInt sum = new MatrixInt(A.rows(), A.columns());
	...
	public static MatrixInt difference (MatrixInt A, MatrixInt B){
		MatrixInt difference = new MatrixInt(A.rows(), A.columns());
	...
	public static MatrixInt product (MatrixInt A, MatrixInt B){
		MatrixInt product = new MatrixInt(A.rows(), A.columns());
	...
	public static MatrixInt scalar_multiplication (MatrixInt A, double scalar){
		MatrixInt scalar_multiplication = new MatrixInt(A.rows(), A.columns());
